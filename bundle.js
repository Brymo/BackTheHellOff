...
},{"./buildAPastor":3,"lodash":1}],3:[function(require,module,exports){
"use strict";
var __spreadArray = (this && this.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
...
function buildPastor(profile) {
    ...
    var validBeliefs = beliefTypes
        .map(function (type) { return doctrine_1.beliefsWithCategories[type]; })
        .reduce(function (acc, current) { return acc.concat(current); }, []);
    var unchosenBeliefs = __spreadArray([], validBeliefs, true);
    var chosenBeliefs = [];
    var _loop_1 = function (i) {
        var choice = Math.floor(Math.random() * unchosenBeliefs.length);
        chosenBeliefs.push(unchosenBeliefs[choice]);
        unchosenBeliefs = unchosenBeliefs.filter(function (_, index) { return index != choice; });
    };
    ...
    return {
        ...
        gender: gender,
        acceptable: chosenBeliefs.filter(function (belief) { return belief.category != "doctrine"; }).length ==
            0
    };
}
exports.buildPastor = buildPastor;

},{"./doctrine":4}],4:[function(require,module,exports){
"use strict";
exports.__esModule = true;
